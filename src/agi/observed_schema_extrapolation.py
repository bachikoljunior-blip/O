...
def run_observed_schema_extrapolation(root: Path, seed: str) -> dict[str, Any]:
    ...
    required_prior_ids = (
        str(recursive["first_candidate_id"]),
        str(recursive["second_candidate_id"]),
        str(recursive["first_expansion_candidate_id"]),
        str(recursive["second_expansion_candidate_id"]),
